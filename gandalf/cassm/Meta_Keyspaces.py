...
def description():
    ...
    #############################################################
    print "Show Cassandra meta keyspaces."
...
def main(commonConfig, scriptConfig, host):
    ...
    cassmHost = host
    cassmPort = str(commonConfig['cassmPort'])
    ...
    logger.info("Cassandra port:     " + cassmPort)
    logger.info("Cassandra keyspace: " + cassmKS)
    logger.info("------------")

    # Execute cqlsh desc keyspaces
    logger.info("Execute cqlsh desc keyspaces")
    cmd = cassmDir + "cqlsh " + cassmHost + " " + cassmPort + " -e 'desc keyspaces;'"
    try:
